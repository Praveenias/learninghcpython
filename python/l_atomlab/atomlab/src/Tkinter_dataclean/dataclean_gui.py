'''
  Tkinkter GUI For dataclean and main landing page
  dataclean process for excel templates can be done through GUI
...
# from database_config_gui import Database_config
# from risk_calculation_gui import Risk_calculation_gui
...
class App(tk.Tk):
    def __init__(self):
        ...
        # self.Risk_calculation_gui = Risk_calculation_gui

        ## Defining Frames and Packing it
        for F in {Dataclean, GetExemption}: #Database_config,Risk_calculation_gui
...
class Dataclean(tk.Frame):
    def __init__(self, parent, container,datacheck):
        '''
        Constructor that loads Tkinker container
        and initiliaze the UI Look 
        '''
    ...
    def select_file(self)->None:
        ''' File selection input Dialog box'''
    ...
    def create_menubar(self, parent):
        ''' Menubar UI for dataclean MENUBAR'''
...
class GetExemption(tk.Frame):
    ...
    def create_menubar(self, parent):
        ''' Menubar UI for Get Exemption MENUBAR'''
        menubar = Menu(parent, bd=4, relief=RAISED, activebackground="#80B9DC")
        menu = Menu(menubar, tearoff=0, relief=RAISED, activebackground="#026AA9")
        menubar.add_cascade(label="DATACLEAN",command=lambda: parent.show_frame(parent.Dataclean))
        menubar.add_cascade(label="GetExemption",command=lambda: parent.show_frame(parent.GetExemption))  
